...
# print("Active Cases", int(data1[0].text.strip().replace(",",""))+int(data1[1].text.strip().replace(",","")))
# print("Total Deaths: ", data[1].text.strip())
# print("Serious or Critical: ", data1[1].text.strip())
# print("Total Recovered: ", data[2].text.strip())
# print("Death Rate: ", float(data[1].text.strip().replace(",",""))/float(data[0].text.strip().replace(",",""))*100)
# print("Recovery Rate: ", float(data[2].text.strip().replace(",",""))/float(data[0].text.strip().replace(",",""))*100)
# print("In Mild Condition: ", data1[0].text.strip())
